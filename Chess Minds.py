...
ORIGINAL_BLACK     = ( 0 ,  0 ,  0 )
BROWN_LIGHT        = (255, 211, 155)
BROWN_DARK         = (94 , 38 , 18 )

BOARD_COLORS = [(BROWN_LIGHT,BROWN_DARK),
                (ORIGINAL_WHITE,ORIGINAL_BLACK),
...
BOARD_COLOR = (BROWN_LIGHT,BROWN_DARK)
...
def make_AI_move(game, color):
    set_title(SCREEN_TITLE + " - AI's Turn...")
...
#giving player the choise of Color
root = Tk()

def Close():
    root.destroy()

photo = PhotoImage(file = 'images/chess_image.png')
root.iconphoto(False, photo)

root.title("Side Selector")

button1 = Button(root,text= "Play as White",command=play_as_white)

button2 = Button(root,text= "Play as Black",command=play_as_black)



lable = Label(root,text ="You can Minimise the screen")
lable.pack() 
lable = Label(root,text ="after you have selected the side")
lable.pack() 
